...
import com.godarmed.microservice.consumerdemo1.validater_demo.config.ValidMethod;
...
public class ResourceBindingRuleDTO implements Serializable {
    ...
    class NumInValid implements ValidMethod<Long,List<Integer>>{
        @Override
        public List<Integer> method(Long aLong) {
            return null;
        }
    }
    ...
    @NumIn(message="规则状态超出范围", groups = {AddOne.class,UpdateOne.class})
